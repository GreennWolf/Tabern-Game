...
### Enanos (NO CREEN EN MAGIA/DEIDADES)
...
- Druida
- Clérigo
- (Cualquier clase que use magia o sirva a deidades)

⚠️ **RARO PERO POSIBLE:**
- Paladín (si es honor cultural, NO magia divina) - 1% probabilidad

✅ **COMÚN:**
- Guerrero (40%)
- Artífice (25%) - magia mecánica, no "real"
- Pícaro (15%)
- Bárbaro (10%)
- Monje (5%)
- Artesano (4%)
...
**Elfos del Bosque:**
- ❌ Bárbaro (muy raro, 1%)
- ✅✅✅ Druida, Guardabosques, Mago (muy común)

**Elfos de la Noche:**
- ❌ Clérigo de luz (religioso)
- ❌ Paladín (generalmente)
- ✅✅✅ Pícaro, Monje, Guardabosques

**Minotauros:**
- ❌ Mago, Hechicero (raro, 2%)
- ✅✅✅ Guerrero, Bárbaro (muy común, 70%)
...
**Dracónidos:**
- Cualquier clase posible (raza versátil)
- Hechicero muy común (magia innata dracónica)

**Duendes:**
- ❌ Paladín, Guerrero (raro, 2%)
- ✅✅✅ Pícaro (60%), Bardo (20%)
